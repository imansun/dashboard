...
// src\components\shared\table\ItemViewTypeSelect.tsximport { Table } from "@tanstack/react-table";
...
export function ItemViewTypeSelect({ table }: { table: Table<any> }) {
  ...
  return (
    ...
    >
      <Button
        data-tooltip
        data-tooltip-content="نمای لیست"
        data-tab-item
        className={clsx(
      ...
      <Button
        data-tooltip
        data-tooltip-content="نمای شبکه‌ای"
        data-tab-item
        className={clsx(
          "shrink-0 rounded-sm px-1.5 py-1 font-medium whitespace-nowrap",
          viewType === "grid"
