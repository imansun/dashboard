// src\components\shared\table\SelectedRowsActions.tsx
// Import Dependencies
import {
  Menu,
  MenuButton,
...
export function SelectedRowsActions({
  ...
  const handleDeleteRows = () => {
    invariant(table.options.meta?.deleteRows, "deleteRows تعریف نشده است");
    ...
    >
      <div className="flex h-full items-center justify-between rounded-t-lg px-4 sm:px-5">
        <p className="font-medium">
          <span>{selectedRows.length} انتخاب شده</span>
        ...
        <div className="flex space-x-1.5">
          ...
          >
            ...
            <span className="max-sm:hidden">لغو</span>
          </Button>
          <Menu as="div" className="relative inline-block text-left">
            ...
            >
              ...
              <span className="max-sm:hidden"> بیشتر</span>{" "}
            </MenuButton>
            <Transition
              as={Fragment}
