// src\components\template\RightSidebar\Widgets.tsx
// Import Dependencies
...
const chart1config: ApexOptions = {
  colors: ["#F7931A"],
  chart: {
    stacked: false,
...
const chart2config: ApexOptions = {
  colors: ["#3AC5BC"],
  chart: {
    stacked: false,
    parentHeightOffset: 0,
    ...
    <>
      <div className="mt-4 grid grid-cols-2 gap-3 px-3">
        <Box className="rounded-lg bg-gray-100 px-2.5 py-2 dark:bg-dark-600">
          ...
          <p className="mt-0.5 text-tiny-plus uppercase">ساعات کاری</p>
          <Progress
            isActive
            value={72}
            color="secondary"
        ...
        <Box className="rounded-lg bg-gray-100 px-2.5 py-2 dark:bg-dark-600">
          ...
          <p className="mt-0.5 text-tiny-plus uppercase">وظایف تکمیل شده</p>
          <Progress
            value={34}
            color="success"
            classNames={{
      ...
      <div className="mt-4 px-3">
        <h2 className="line-clamp-1 text-xs-plus font-medium tracking-wide text-dark-700 dark:text-gray-100">
          بازار سهام
        </h2>
          ...
          <Box className="rounded-lg bg-gray-100 p-2.5 dark:bg-dark-600">
            <div className="-mx-1 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs">بیت‌کوین</p>
              </div>
            </div>
