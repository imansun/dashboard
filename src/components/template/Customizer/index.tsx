// src\components\template\Customizer\index.tsx
// Import Dependencies
import {
  Dialog,
  DialogPanel,
...
const lightColors: TlightColors = [
  {
    color: 'slate',
    lable: 'سنگی'
  },
...
function CustomizerContent({ close }: { close: () => void }) {
            ...
            <Radio value="system" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="text-xs-plus mt-1.5 text-center">سیستم</p>
                </>
              )}
            </Radio>
            ...
            <Radio value="dark" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  />
                  <p className="text-xs-plus mt-1.5 text-center">تاریک</p>
                </>
              )}
            </Radio>
          </div>
            ...
            >
              {({ checked }) => (
                <>
                  ...
                  <p className="text-xs-plus mt-1.5 text-center">چیدمان اصلی</p>
                </>
              )}
            </Radio>
            ...
            <Radio value="sideblock" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="text-xs-plus mt-1.5 text-center">بلوک کناری</p>
                </>
              )}
            </Radio>
          </div>
              ...
              >
                {({ checked }) => (
                  <>
                    <Placeholder
                      checked={checked}
                      bg={colors[item.color][200]}
                      card="#fff"
                      content={colors[item.color][400]}
                    />
            ...
            {darkColors.map((item) => (
              ...
              >
                {({ checked }) => (
                  <>
                    <Placeholder
                      bg={colors[item.color][900]}
                      card={colors[item.color][700]}
                      content={colors[item.color][400]}
                      checked={checked}
                    />
                    <p className="text-xs-plus mt-1.5 text-center capitalize">
